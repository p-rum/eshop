...
import cz.my.company.eshop.exception.impl.ValidationException
...
/**
 * Base cz.my.company.eshop.exception handler class containing helper methods and provides an unified
...
abstract class AbstractExceptionHandler {
   ...
   *
   * @param status         Http status dependeing on cz.my.company.eshop.exception
   * @param message        Fills `message` field in a common object, for SMS Gateway business exceptions,
   * [cz.my.company.eshop.exception.getLabel] should be used to obtain value for this argument
   * @param e              Caught cz.my.company.eshop.exception
  ...
  /**
   * Logs cz.my.company.eshop.exception in [org.slf4j.event.Level.WARN] level (according to
  ...
  /**
   * Logs cz.my.company.eshop.exception in [org.slf4j.event.Level.ERROR] level (according to
   * when stacktrace is always visible.
   *
   * @return
   */
  private fun logError(): BiConsumer<ErrorResponse, Throwable> {
